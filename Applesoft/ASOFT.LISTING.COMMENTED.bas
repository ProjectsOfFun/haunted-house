...
REM CHANGES DEPENDING ON COMPUTER TYPE
65 TEXT : HOME

REM V IS NUMBER OF VERBS, W IS OBJECT WORDS, G IS GETTABLE OBJECTS
70 V=25 : W=36 : G=18

REM THIS LINE SENDS PROGRAM TO INITIALIZATION ROUTINE
80 GOSUB 1600

REM DESCRIPTION & FEEDBACK
...
REM DON'T RECOCOGNIZE OBJECT
360 IF W$ > "" AND OB = 0 THEN M$ = "THAT'S SILLY!"

REM VERB DOESN'T MATCH, SET VERB TO NUMBER OF VERBS PLUS 1
370 IF VB = 0 THEN VB = V + 1

REM NO NOUN GIVEN
380 IF W$ = "" THEN M$ = "I NEED TWO WORDS"

REM YOU TYPED A VERB AND AN OBJECT BUT VERB IS UNKNOWN
390 IF VB > V AND OB > 0 THEN M$ = "YOU CAN'T '" + Q$ + "'"

REM BOTH VERB AND OBJECT ARE NOT RECOGNIZED
400 IF VB > V AND OB = 0 THEN M$ = "YOU DON'T MAKE SENSE"

REM NOT CARRYING OBJECT
410 IF VB < V AND OB > 0 AND C(OB) = 0 THEN M$ = "YOU DON'T HAVE '" + W$

420 IF F(26) = 1 AND RM = 13 AND INT ( RND (1) * 3) + 1 < > 3 AND VB < > 21 THEN M$ = "BATS ATTACKING!" : GOTO 90
430 IF RM = 44 AND INT ( RND (1) * 2) = 1 AND F(24) < > 1 THEN F(27) = 1
440 IF F(0) = 1 THEN LL = LL - 1
450 IF LL < 1 THEN F(0) = 0


REM "HELP","CARRYING","GO","N","S","W","E","U","D","GET","TAKE","OPEN","LOOK","READ","SAY"
REM "DIG","SWING","CLIMB","LIGHT","UNLIGHT","SPRAY","USE","UNLOCK","LEAVE","SCORE"
...
470 IF LL = 10 THEN M$ = "YOU CANDLE IS WANING!"
...
REM D IS THE DIRECTION OF MOVEMENT:
REM 1 NORTH, 2 SOUTH, 3 WEST, 4 EAST
REM 5 UP, 6 DOWN
640 D = 0
...
790 IF F(27) = 1 AND RM = 52 THEN M$ = "THE GHOSTS WON'T LET YOU MOVE!": RETURN 
...
REM EXAMINE
1070 IF OB = 30 THEN F(18) = 0:M$ = "SOMETHING HERE!" : REM COAT
1080 IF OB = 31 THEN M$ = "THAT'S VERY DISGUSTING!" : REM RUBBISH
1090 IF (OB = 28 OR OB = 29) THEN M$ = "THERE IS A DRAWER" : REM DESK OR DRAWER
1100 IF OB = 33 OR OB = 5 THEN GOSUB 1140 : REM BOOKS OR SCROLL
1110 IF RM = 43 AND OB = 35 THEN M$ = "THERE IS SOMETHING BEYOND.." : REM WALL IN STUDY
...
1160 IF C(5) = 1 AND OB = 5 THEN M$ = "THE SCRIPT IS IN ALIEN TONGUE"
1170 RETURN

REM SAY
1180 M$ = "OK '" + W$ + "'"
1190 IF C(3) = 1 AND OB = 34 THEN M$ = "*MAGIC OCCURS*": IF RM < > 45 THEN RM = INT (64 * RND (1))
...
1310 IF OB = 14 AND C(14) < > 1 AND RM = 7 AND F(14) = 0 THEN M$ = "YOU SEE A THICK FOREST AN CLIFF SOUTH" : F(14)=l : RETURN
...
1540 NEXT I
1550 IF S = 17 AND C(15) < > 1 AND RM < > 57 THEN PRINT "YOU HAVE EVERYTHING" : PRINT "RETURN TO GATE FOR FINAL SCORE"
1560 IF S = 17 AND RM = 57 THEN PRINT "DOUBLE YOUR SCORE FOR REACHING HERE" : S = S * 2
...
1640 READ L(I)
1650 NEXT I
1660 DATA "HELP","CARRYING","GO","N","S","W","E","U","D","GET","TAKE","OPEN","LOOK","READ","SAY"
...
1825 DATA "WEED PATCH","FOREST","THICK FOREST","BLASTED TREE"
1840 DATA "CORNER OF HOUSE","ENTRANCE TO KITCHEN","KITCHEN & GRIMY COOKER","SCULLERY DOOR"
1845 DATA "ROOM WITH INCHES OF DUST","REAR TURRENT ROOM","CLEARING BY HOUSE","PATH"
1860 DATA "SIDE OF HOUSE","BACK OF HALLWAY","DARK ALCOVE","SMALL DARK ROOM"
1865 DATA "BOTTOM OF SPIRAL STAIRCASE","WIDE PASSAGE","SLIPPERY STEPS"
1880 DATA "CLIFFTOP"
1881 DATA "CRUMBLING WALL","GLOOMY PASSAGE"
1882 DATA "POOL OF LIGHT","IMPRESSIVE VALTED HALLWAY"
1885 DATA "HALL BY THICK WOODEN DOOR","TROPHY ROOM","CELLAR WITH BARDED WINDOW","CLIFF PATH"
...
1920 DATA "CLOSET","FRONT LOBBY","LIBRARY OF EVIL BOOKS","STUDY WITH DESKS AND HOLE IN WALL"
...
1945 DATA "UPPER GALERY","MARSH BY WALL","MARSH","SOGGY PATH"
1960 DATA "BY TWISTED RAILING","PATH THROUGH IRON GATE","BY RAILINGS","BENETH FRONT TOWER"
